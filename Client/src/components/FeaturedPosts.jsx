...
const FeaturedPosts = () => {
  ...
  return (
    <div className="mt-8 flex flex-col lg:flex-row gap-8">
      ...
      <div className="w-full lg:w-1/2 flex flex-col gap-4">
        {/* Second */}
        {posts[1] && <div className="flex flex-col sm:flex-row lg:h-1/3 justify-between gap-4">
          {posts[1].img && <div className="w-full sm:w-1/3 aspect-video">
            <Image
              src={posts[1].img}
        ...
        {/* Third */}
        {posts[2] && <div className="flex flex-col sm:flex-row lg:h-1/3 justify-between gap-4">
          {posts[2].img && <div className="w-full sm:w-1/3 aspect-video">
            <Image
              src={posts[2].img}
              className="rounded-3xl object-center w-full h-full"
              w="298"
        ...
        {/* Fourth */}
        {posts[3] && <div className="flex flex-col sm:flex-row lg:h-1/3 justify-between gap-4">
          {posts[3].img && <div className="w-full sm:w-1/3 aspect-video">
            <Image
              src={posts[3].img}
              className="rounded-3xl object-center w-full h-full"
              w="298"
